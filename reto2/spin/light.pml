...
active proctype fsm(){
    ...
    :: if
        ...
        :: (state == 1) -> atomic {
            ...
            :: (!presencia) -> state = 2; luz = 0; finPresencia=0; presencia =0;
            fi
        }
        :: (state == 2) -> atomic {
            if
            :: (!finPresencia && !presencia) -> state = 2; luz = 1;   presencia=0;
            :: (finPresencia && !presencia) -> state = 0; luz = 0; finPresencia=0; presencia=0;
            :: (presencia) -> state = 1; luz = 1; presencia=0; finPresencia=0;
            fi
        }
